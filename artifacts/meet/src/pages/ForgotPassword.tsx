          ...
          <CardContent>
            {!resetLink ? (
              ...
              <div className="space-y-4 text-center py-2">
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 dark:text-emerald-400 rounded-xl text-sm font-medium">
                ...
                <div className="bg-zinc-50 dark:bg-black/60 p-3 rounded-lg border border-zinc-200 dark:border-white/5 text-left select-all break-all text-xs font-mono text-zinc-700 dark:text-zinc-300">
                  {resetLink}
                </div>
                <Button
                  onClick={() => {
