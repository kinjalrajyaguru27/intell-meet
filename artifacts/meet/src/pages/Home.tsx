            ...
            {filteredMeetings.map((meeting: any) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 border border-zinc-200 dark:border-white/5 ${isPast ? "bg-zinc-100 dark:bg-white/5 text-zinc-500" : "bg-primary/10 text-primary"
                      }`}>
                      <Video className="w-5 h-5" />
                    </div>
